...
import 'package:qduo/database/PlacementCourse_data.dart';
import 'package:qduo/screens/Navigation_bar/Navigationbar.dart';
import 'package:qduo/screens/Navigation_pages/chats.dart';


class Campus_placement extends StatefulWidget {
  const Campus_placement({Key? key}) : super(key: key);

  @override
  State<Campus_placement> createState() => _Campus_placementState();
}

class _Campus_placementState extends State<Campus_placement> {

 TextEditingController Coursefield = TextEditingController();
  ...
  void PostAdd() async {
    ...
    String res = await PlacementCourseData().placementcourse(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Campus Placement Courses'),
      ),
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  // hintText: 'Exam Name',
                  label: Text('field Name for Placement'),
   ...
   SizedBox(height: 15,),
              ...
              SizedBox(
               ...
               TextField(
                ...
                decoration: InputDecoration(
                  // hintText: 'Exam Name',
                  label: Text('Subcategory Of field'),
                  border: OutlineInputBorder(),
                ),
              ),
