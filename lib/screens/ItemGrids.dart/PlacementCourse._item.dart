...
import 'package:qduo/itemcard/placement.dart';
...
class placement_item extends StatefulWidget {
  const placement_item({Key? key}) : super(key: key);

  @override
  State<placement_item> createState() => _placement_itemState();
}

class _placement_itemState extends State<placement_item> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Placement Courses'),
        ...
        child: StreamBuilder<QuerySnapshot>(
            ...
            child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('PlacementCourse').snapshots(),
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return Center(
                child: CircularProgressIndicator(),
