  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: StreamBuilder<QuerySnapshot>(
            ...
            child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('SkillCourses').snapshots(),
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return Center(
                child: CircularProgressIndicator(),
              ...
              return Padding(
                ...
                child: GridView(
                  ...
                  children: snapshot.data!.docs
                      .map((detail) => skillitemCard(() {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => skillDateialpage(detail)));
                          }, detail))
                      .toList(),
                ),
              );
