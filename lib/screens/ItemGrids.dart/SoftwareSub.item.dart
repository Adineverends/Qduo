...
import 'package:qduo/itemcard/softwaresub.dart';
import 'package:qduo/screens/DetailedPages/app.dart';
import 'package:qduo/screens/DetailedPages/software.dart';
import 'package:qduo/screens/Navigation_pages/home/seeall_items/appSub.dart';

class softwareSubscription_Item extends StatefulWidget {
  const softwareSubscription_Item({Key? key}) : super(key: key);

  @override
  State<softwareSubscription_Item> createState() => _softwareSubscription_ItemState();
}

class _softwareSubscription_ItemState extends State<softwareSubscription_Item> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('Software Subscription'),
        ...
        child: StreamBuilder<QuerySnapshot>(
            ...
            child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance.collection('SoftwareSubscription').snapshots(),
          builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return Center(
                child: CircularProgressIndicator(),
              ...
              return Padding(
                ...
                child: GridView(
                  ...
                  children: snapshot.data!.docs
                      .map((detail) => softwareitemcard(() {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (_) => softwaredetailpage(detail)));
                          }, detail))
                      .toList(),
                ),
              );
