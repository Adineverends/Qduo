...
class examseeALL extends StatelessWidget {
  const examseeALL({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('CompetetiveExamCourse')
            .snapshots(),
