...
class SoftwareseeALL extends StatelessWidget {
  const SoftwareseeALL({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('SoftwareSubscription')
            .snapshots(),
                            ...
                            child: Column(
                              ...
                              children: [
                                 Text(
                                          ...
                                          Text(
                                            storedocs[index]['SoftwareCategory'],
                                            style: TextStyle(
                                              fontSize: 21,
                                            ),
                                          ),
